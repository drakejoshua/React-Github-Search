    ...
    return ( 
      ...
      <div>
        ...
        <div id="hero" className="flex flex-nowrap items-center pt-24 pb-9 px-36 bg-gray-700">
          ...
          <form className="inline-flex items-center flex-grow">
            <input type="text" id="username-input" className="flex-grow text-black rounded-2xl text-sm py-2 px-4 mr-3 focus:outline-none" placeholder="Try @drakejoshua"/>
