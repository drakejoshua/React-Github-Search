  ...
  render() {
    return ( 
      ...
      <div>
        ...
        <div id="hero" className="flex flex-wrap items-center pt-24 pb-9 md:px-36 px-8 bg-gray-700">

          <h1 className="md:text-2xl text-xl font-medium md:mr-4 capitalize flex items-center gap-x-2 sm:w-full mb-6 lg:mb-3 xl:mb-0 lg:w-fit">
            <svg className="inline-block w-20 h-14 md:w-12 md:h-12 self-center">
          ...
          <form className="inline-flex flex-wrap md:flex-nowrap items-center flex-grow" onSubmit={ this.submitSearch }>

            {/* search input */}
            <input type="text" id="username-input" 
              className="md:flex-grow w-full text-black rounded-2xl text-sm py-2 px-4 mr-3 focus:outline-none mb-3 md:mb-0" 
              placeholder='Try "@drakejoshua"'
            ...
            <button id="submit-btn" 
              className="inline-flex items-center gap-x-2 w-min rounded-2xl px-3 py-2 bg-blue-500 text-white btn-interaction"> 
